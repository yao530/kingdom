...
public class HttpUtil {
    ...
    public static final String SEPARATOR_SLASH_ = "/";
...
//        log.info(result);
    ...
    protected static HttpURLConnection getConnection(URL url, String method) throws IOException {
        ...
        if (StringUtils.equals(URL_PROTOCOL_HTTPS, url.getProtocol())) {
    ...
    protected static String getFileName(String mediaUrl) {
        return StringUtils.substringAfterLast(mediaUrl, SEPARATOR_SLASH_);
    }
